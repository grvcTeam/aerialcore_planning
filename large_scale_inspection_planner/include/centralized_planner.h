...
private:
    ...
    std::vector<aerialcore_msgs::Edge> edges_MILP_;   // Vector of edges possible in which for each pair of nodes (i,j) there is information of whether it is an inspection edge or not. If it is, it still can be used for cross-heading.

...
private:
    ...
    struct UAV {
        ...
        int last_segment = 0;      // First node of the segment that this UAV was doing for this plan the last time the Plan Monitor was called. // TODO: 0 when mission finished.

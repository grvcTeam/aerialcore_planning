...
bool PlanMonitor::enoughDeviationToReplan(/*plan, pose, battery, */const std::vector< std::vector<float> >& _distance_cost_matrix, const std::vector< std::vector<float> >& _battery_drop_matrix) {

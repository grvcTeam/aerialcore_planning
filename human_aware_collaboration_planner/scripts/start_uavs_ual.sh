...
'
  'Mavros' 'sleep 1; roslaunch human_aware_collaboration_planner mavros_experiment.launch id:='"$UAV_ID"' rtcm_topic:="/rtcm_stream"
'
...
'
  'Rosbag' 'sleep 10; roslaunch human_aware_collaboration_planner rosbag_recorder_experiment.launch record_duration:=360 id:='"$UAV_ID"'
'
)
